...
h2. Start by installing Ruby 1.8.7
    Windows: Make sure you allow the binaries to be added to your PATH
	
h2. Open a new command prompt and install a few necessary gems:
    gem install bundler
    gem install nokogiri -v 1.5.11
    gem install log4r

h2. Locate your installation of SourceGear Vault Client.
...
h2. Create your folder structure for where you want your new git repository to be created.
